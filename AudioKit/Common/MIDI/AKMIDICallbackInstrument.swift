...
open class AKMIDICallbackInstrument: AKMIDIInstrument {
    ...
    ///
    /// - Parameters:
    ///   - harmonicNoteNumber: MIDI Note Number being started
    ...
    override open func start(harmonicNoteNumber: HarmonicNoteNumber,
        ...
        triggerCallbacks(AKMIDIStatus(type: .noteOn, channel: channel), data1: MIDIByte(harmonicNoteNumber), data2: velocity)
    }

    /// Will trigger in response to any noteOff Message
    ///
    /// - Parameters:
    ///   - harmonicNoteNumber: MIDI Note Number being stopped
    ///   - channel:    MIDI Channel
    ///
    override open func stop(harmonicNoteNumber: HarmonicNoteNumber, channel: MIDIChannel, offset: MIDITimeStamp = 0) {
        triggerCallbacks(AKMIDIStatus(type: .noteOff, channel: channel), data1: MIDIByte(harmonicNoteNumber), data2: 0)
    }
